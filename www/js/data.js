...
const EATS = [
  {
    ...
    meal: "Lunch / Brunch",
    price: "££",
    notes: "Locally sourced brunch & lunch with a colourful kids' menu. Relaxed pace — good for Day 1 arrival or a quiet morning.",
  ...
  {
    city: "Edinburgh",
    area: "Old Town / near the Fringe",
    name: "Civerinos (Hunter Square)",
    meal: "Lunch",
    price: "£",
    notes: "Casual sit-down pizza two minutes from the Fringe hub at George Square Gardens. Quick, cheap, no reservation needed — good fit after a morning kids' show.",
  ...
  },
  {
    ...
    meal: "Lunch / Dinner",
    price: "££",
    notes: "Stirling's Restaurant of the Year (2023 & 2025) — steaks, pizza and pasta alongside a dedicated kids' menu. Central, with free parking.",
    website: "https://fletchersstirling.co.uk/",
    mapsQuery: "Fletcher's Restaurant Stirling",
  },
  {
    city: "Stirling",
    area: "City centre",
    ...
    price: "£",
    notes: "Small, warm, independent bistro — a cheaper, quicker option if Fletcher's is busy or you need something fast before the train.",
    website: "https://www.gabesdiner.co.uk/",
    mapsQuery: "Gabe's Diner Stirling",
  },
  {
    city: "Glasgow",
    area: "Kelvingrove",
    ...
    meal: "Lunch",
    price: "£",
    notes: "Sits right inside Kelvingrove Park by the museum, mostly Fairtrade/organic, relaxed — an easy stop straight after the gallery.",
  ...
  },
  {
    ...
    meal: "Dinner",
    price: "££",
    notes: "Modern European, family-friendly West End favourite near Kelvingrove — good for dinner before the train back to Edinburgh.",
    website: "https://www.theleftbank.co.uk/",
    mapsQuery: "The Left Bank Gibson Street Glasgow",
  },
];
